...
<html lang="en">
  <head>
    ...
    <title>Cursos de Catedráticos</title>
  ...
  <body>
    ...
    <div class="title-bar">
            <div class="container">
                <h1>MODIFICAR ASIGNACIÓN DE CATEDRÁTICO A CURSO</h1>
               ...
               <div class="col-md-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">ID CURSO</h4>
                        </div>
                        <div class="panel-body">
                            <form>
                            <div class="form-group">
                                <label>ID CURSO</label>
                                <input type="number" class="form-control" placeholder="ingrese curso">
                            </div>
                           <div class="form-group">
                                <label>AÑO</label>
                                <input type="date" class="form-control" placeholder="ingrese año">
                            </div>
                            <div class="form-group">
